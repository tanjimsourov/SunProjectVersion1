...
export default function NlElevenPage(){
    ...
    return(
        <>
            <div className="page full-screen background eleven">
                ...
                <div className="grid">
                    <Sidebar title="Duurzaam dankzij zonne-energie" placeholder={PlaceHolder}/>
                            ...
                            <div className="box__content">
                                <div className="wraper">
                                    <div className="text-wrapper">
                                        <h2>CO<sub>2</sub>-reductie 2023: 133,13 ton</h2>
                                        <h2>CO<sub>2</sub>-reductie 2024: 9,86 ton <br></br>tegen 3.952 KWH</h2>
                                    </div>
                                </div>
