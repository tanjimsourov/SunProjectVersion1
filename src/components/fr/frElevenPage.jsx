    ...
    return(
        <>
            <div className="page full-screen background eleven">
                ...
                <div className="grid">
                    <Sidebar title="Durable grâce à l'énergie solaire" placeholder={PlaceHolder}/>
                            ...
                            <div className="box__content">
                                ...
                                <div className="wraper">
                                    <div className="text-wrapper">
                                        <h2>Réduction de CO<sub>2</sub> 2023 : 133,13 tonnes</h2>
                                        <h2>Réduction CO<sub>2</sub> 2024 : 9,86 tonnes <br></br>contre 3 952 KWH</h2>
                                    </div>
                                </div>
